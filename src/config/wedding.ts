...
export const weddingConfig = {
  ...
  galleryPhotos: [
    ...
    {
      id: "gal-6",
      src: "/Image/Maappillai Azhaippu.png",
      category: "wedding",
  ...
  familyMembers: [
    ...
    {
      id: "fam-6",
      name: { en: "Gayathri Jagannathan", ta: "காயத்ரி ஜெகந்நாதன்" },
      relation: { en: "Groom's Sister | Graphic Designer", ta: "மணமகனின் சகோதரி | கிராஃபிக்ஸ் கலைஞர்" },
      role: "sibling",
  ...
  dictionary: {
    en: {
      ...
      searchByFace: "Find My Photos (Face Search)",
      faceSearchTitle: "Find Photos with Your Face",
      faceSearchDesc: "Upload your selfie or photo to instantly find and download only the photos you appear in.",
      uploadSelfie: "Upload Selfie / Portrait",
      takeSelfie: "Take Live Selfie",
      dragDropFace: "Drop your portrait or selfie here, or click to browse",
      searchingFaces: "Analyzing facial features across wedding albums...",
      foundMatches: "Photos Found with Your Face",
      noMatchesFound: "No photos found matching this face. Try uploading a clearer frontal selfie.",
      downloadMyPhotos: "Download My Photos (ZIP)",
      clearFaceSearch: "Clear Face Filter",
      matchConfidence: "Match Confidence",
      pythonApiConfig: "Python Face API Settings",
      pythonApiUrl: "Python Face API Endpoint URL",
      pythonApiHelp: "Connect your custom Python Face Recognition service (DeepFace / InsightFace / FastAPI). Built-in intelligent matcher is also active.",
      matchedPhotosOnly: "Showing only your matched face photos",
      downloadSelected: "Download Selected (ZIP)",
      selectPhotos: "Select Photos",
      cancelSelect: "Cancel Selection",
      selectAll: "Select All",
      deselectAll: "Deselect All",
      downloadPhoto: "Download High-Res",
      selectedCount: "Photos Selected",
      downloadingZip: "Preparing ZIP Archive...",
    ...
    ta: {
      ...
      searchByFace: "என் புகைப்படங்களை தேடு (Face AI)",
      faceSearchTitle: "முகம் மூலம் புகைப்படங்களை தேடுங்கள்",
      faceSearchDesc: "உங்கள் முகப் படத்தை அல்லது செல்ஃபியை பதிவேற்றி, உங்கள் முகம் உள்ள அனைத்து திருமண புகைப்படங்களையும் எளிதாகக் கண்டறிந்து பதிவிறக்கம் செய்யுங்கள்.",
      uploadSelfie: "புகைப்படம் பதிவேற்றுக",
      takeSelfie: "நேரடி செல்ஃபி",
      dragDropFace: "உங்கள் முகப் படத்தை இங்கே பதிவேற்றவும் அல்லது தேர்ந்தெடுக்கவும்",
      searchingFaces: "திருமண புகைப்படங்களில் உங்கள் முகம் ஸ்கேன் செய்யப்படுகிறது...",
      foundMatches: "உங்கள் முகத்துடன் கண்டறியப்பட்ட படங்கள்",
      noMatchesFound: "இந்த முகத்துடன் படங்கள் எதுவும் கண்டறியப்படவில்லை. மற்றொரு தெளிவான செல்ஃபியை முயற்சிக்கவும்!",
      downloadMyPhotos: "என் புகைப்படங்களை பதிவிறக்குக (ZIP)",
      clearFaceSearch: "வடிகட்டியை நீக்கு (அனைத்தும்)",
      matchConfidence: "முகப் பொருத்தம்",
      pythonApiConfig: "Python Face API அமைப்புகள்",
      pythonApiUrl: "Python Face API இணைய முகவரி",
      pythonApiHelp: "தங்களின் சொந்த Python Face Recognition சேவையை (FastAPI / DeepFace) இணைக்கலாம்.",
      matchedPhotosOnly: "உங்கள் முகம் உள்ள படங்கள் மட்டுமே காட்டப்படுகின்றன",
      downloadSelected: "தேர்ந்தெடுத்தவை பதிவிறக்குக (ZIP)",
      selectPhotos: "படங்களைத் தேர்வு செய்",
      cancelSelect: "தேர்வை ரத்து செய்",
      selectAll: "அனைத்தையும் தேர்வு செய்",
      deselectAll: "தேர்வை நீக்கு",
      downloadPhoto: "பதிவிறக்குக",
      selectedCount: "படங்கள் தேர்வு செய்யப்பட்டுள்ளன",
      downloadingZip: "ZIP கோப்பு தயாராகிறது...",
